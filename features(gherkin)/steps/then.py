...
@then('Вижу в "{name}"/"{selector}" сегодняшнюю дату')
def step_check_value_today_date(context, selector, name):
    page = ClassCheck(context)
    page.check_value_equals_today_date(context.page.locator(selector=selector), name=name)
